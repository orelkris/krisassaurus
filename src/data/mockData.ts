...
export const mockPosts: Post[] = [
  {
    ...
    content: [
      'When I think about how I plan to physically set up my classroom for social studies, I keep coming back to the idea that classrooms are not neutral spaces. The way a room is organized shapes participation, communication, and the relationships students build with one another. Because social studies is rooted in discussion, inquiry, perspective-taking, and community, I want my classroom to reflect those values physically as well as academically.',
  ...
  },
  {
    ...
    content: [
      'When I think about teaching Social Studies, I think less about memorizing isolated facts and more about helping students understand relationships between people, communities, histories, environments, and ideas. I want students to feel that Social Studies is connected to real human experiences and not just something that exists inside a textbook. Students are far more likely to engage deeply with learning when they feel emotionally safe, connected to the material, and encouraged to share their own perspectives and experiences. To me, learning should feel participatory and relational, where students recognize that their ideas, questions, and observations matter within the classroom community.',
      'Because of this, many of my instructional approaches focus on storytelling, inquiry, reflection, collaboration, and discussion. Storytelling is especially important to me because stories make concepts more memorable, emotionally meaningful, and easier to connect to lived experiences. I also value collaborative discussion and community-building practices, such as circles and shared inquiry, because students learn from hearing multiple perspectives and building understanding together. Reflection through journals and multimodal expression through sketching, discussion, diagrams, and writing allow students to organize their thinking and communicate understanding in different ways. Through inquiry-based and interdisciplinary learning, students are encouraged to explore ideas critically, observe patterns, and connect classroom learning to the wider world around them.',
...

  {
    ...
    content: [
      'When I think about planning units now, I keep coming back to one idea: students do not experience the world in separate subjects. A conversation about community can quickly become a story, a piece of art, or a discussion about fairness and belonging. The lines between Social Studies, Language, and the Arts may help organize a timetable, but they are not really how curiosity works for children.',

      'Because of this, I do not think about integration as “fitting” social studies into other subjects. I think about each subject as a different lens looking at the same world. Language helps students communicate meaning through stories and discussion. The Arts help students express emotions, identities, and experiences creatively. Social studies asks who is affected, whose voices are heard, and what responsibilities people have to one another. Together, these lenses make learning feel more connected and meaningful.',

      'A Grade 2 inquiry into communities and belonging is one example of how I would approach integration. In social studies, students might explore the communities they belong to and think about how people help make communities welcoming and connected. In Language, students could read and discuss stories about families, traditions, and neighbourhoods while sharing their own experiences through speaking and writing activities. In the Arts, students might create visual representations of important places in their community or dramatize community stories through role play.',

      'I want social studies to remain at the centre of the learning, acting as the thread that ties the other subjects together. A map becomes more than geography when students begin asking who lives there and how communities are shaped. A story becomes more than a reading activity when students think about voice, fairness, and belonging. An art activity becomes more than decoration when students use it to communicate identity, culture, and memory.',
      ...
      'Ultimately, I want my classroom to feel like a place where subjects are always connected, because that is how real curiosity naturally moves through the world.',
    ],
